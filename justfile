...
test:
    ...
    {{t10}} cargo test -p walgit-server --test web_api --test web_ui --test api_v1 --test static_http --test maintain --test routing_prefix --test lfs_upstream --test lfs_signed_url --test drain --test events --test follow --test policy
